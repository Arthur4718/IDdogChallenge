...
You should be able to grab an apk [by clicking here](https://drive.google.com/file/d/1dFy22mHxozj0zcRWT4XTbOqpYXZ3aUK7/view?usp=sharing).

Just run install it normally in your device or emulator. If the Android system prompts you with a message warning about the apk. 
then you should enable its instalation by accepting a security change in your system. Its higly recommended for you to 
turn it back on once you are finished. This behaviour might change depending on your system version. If get any trouble
